                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="float-left">
                                <h1 class="h5 text-gray-800">MENU INFORMASI ORANG HILANG</h1>
                            </div>
                            <div class="float-right">
                                <a href="<?= base_url('admin/informasi/orang/tambah'); ?>" class="btn btn-sm btn-primary">TAMBAH <i class="fas fa-plus-circle"></i></a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('admin/orang_ajax/'); ?>",
                "type": "POST",
                "data": {
                    "publish": function() {
                        return $('#publish').val()
    ...
    function delete_informasi(data) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('admin/orang_delete/') ?>",
                    data: {
                        data: data
                    },
                    dataType: "JSON",
    ...
    function publish_informasi(type, data) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('admin/orang_publish/') ?>",
                    data: {
                        publish: type,
                        id: data
                    },
