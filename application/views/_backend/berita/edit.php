        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col">
                            <h1 class="h5 text-gray-800"><strong>MENU INFORMASI UBAH BERITA</strong></h1>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form id="test" enctype="multipart/form-data" method="POST" onsubmit="return false">
                                <?php foreach ($berita as $record) : ?>
                                    <div class="row mb-3">
                                        <div class="col-sm-2">
                                            <label><strong>Gambar Utama: <i class="text-danger">*</i></strong></label>
                                            <?php $retVal = ($record->TIPE_THUMBNAIL == 'url') ? $record->URL_THUMBNAIL : base_url('assets/upload/berita/') . $record->PATH . '/' . $record->URL_THUMBNAIL; ?>
                                            <img id="image-preview" src="<?= $retVal; ?>" width="140" height="120" onclick="show_modal()">
                                            <input type="hidden" name="id" id="id" value="<?= $record->ID_BERITA; ?>">
                                            <input type="hidden" name="path" id="path" value="<?= $record->PATH; ?>">
                                            <input type="hidden" name="url_thumbnail" id="url_thumbnail" value="<?= $record->URL_THUMBNAIL; ?>">
                                            <input type="hidden" name="tipe_thumbnail" id="tipe_thumbnail" value="<?= $record->TIPE_THUMBNAIL; ?>">
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="row mb-2">
                                                <div class="col">
                                                    <label><strong>Judul Berita: <i class="text-danger">*</i></strong></label>
                                                    <input type="text" class="form-control" name="judul" value="<?= $record->JUDUL; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <label><strong>Tanggal Berita: <i class="text-danger">*</i></strong></label>
                                                    <input type="date" class="form-control" name="tgl" value="<?= $record->CREATE_AT; ?>">
                                                </div>
                                                <div class="col">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            ...
                                            <textarea id="isi" name="isi"><?= $record->ISI; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
...
<script>
    ...
    function form_submit() {
        ...
        $.ajax({
            url: "<?= base_url('admin/berita_update/'); ?>",
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
