                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="float-left">
                                <h1 class="h5 text-gray-800">MENU INFORMASI BERITA</h1>
                            </div>
                            <div class="float-right">
                                <a href="<?= base_url('admin/informasi/berita/tambah'); ?>" class="btn btn-sm btn-primary">TAMBAH <i class="fas fa-plus-circle"></i></a>
                    ...
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th style="max-width: 500px;">Judul</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('admin/berita_ajax/'); ?>",
                "type": "POST",
                "data": {
                    "publish": function() {
                        return $('#publish').val()
    ...
    function publish_informasi(type, data) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('admin/berita_publish/') ?>",
                    data: {
                        publish: type,
                        id: data
                    },
