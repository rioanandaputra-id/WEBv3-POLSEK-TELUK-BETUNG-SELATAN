        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col">
                            <h1 class="h5 text-gray-800"><strong>MENU INFORMASI UBAH TAHANAN</strong></h1>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form id="test" enctype="multipart/form-data" method="POST" onsubmit="return false">
                                <?php foreach ($tahanan as $record) : ?>
                                    <div class="row mb-2">
                                        <div class="col-sm-2">
                                            <label><strong>Foto: <i class="text-danger">*</i></strong></label>
                                            <?php $foto = ($record->TIPE_FOTO == 'url') ? $record->FOTO : base_url('assets/upload/tahanan/') . $record->FOTO; ?>
                                            <img id="image-preview" src="<?= $foto; ?>" width="140" height="120" onclick="show_modal()">
                                            <input type="hidden" name="ID" id="ID" value="<?= $record->ID_TAHANAN; ?>">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="KESATUAN" value="<?= $record->KESATUAN; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
...
<script>
    ...
    function form_submit() {
        ...
        $.ajax({
            url: "<?= base_url('admin/tahanan_update/'); ?>",
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
