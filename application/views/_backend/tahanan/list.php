                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="float-left">
                                <h1 class="h5 text-gray-800">MENU INFORMASI TAHANAN</h1>
                            </div>
                            <div class="float-right">
                                <a href="<?= base_url('admin/informasi/tahanan/tambah'); ?>" class="btn btn-sm btn-primary">TAMBAH <i class="fas fa-plus-circle"></i></a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('admin/tahanan_ajax/'); ?>",
                "type": "POST",
                "data": {
                    "publish": function() {
                        return $('#publish').val()
    ...
    function delete_informasi(data) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('admin/tahanan_delete/') ?>",
                    data: {
                        data: data
                    },
                    dataType: "JSON",
    ...
    function publish_informasi(type, data) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('admin/tahanan_publish/') ?>",
                    data: {
                        publish: type,
                        id: data
                    },
