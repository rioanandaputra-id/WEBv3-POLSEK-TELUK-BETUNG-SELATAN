        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col">
                            <h1 class="h5 text-gray-800"><strong>MENU INFORMASI TAMBAH BARANG HILANG</strong></h1>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form id="test" enctype="multipart/form-data" method="POST" onsubmit="return false">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="datetime-local" class="form-control" name="CREATE_AT">
                                            </div>
                                            <div class="col">
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        <label><strong>Keterangan Barang: <i class="text-danger">*</i></strong></label>
...
<script>
    ...
    function form_submit() {
        ...
        $.ajax({
            url: "<?= base_url('admin/barang_save/'); ?>",
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
