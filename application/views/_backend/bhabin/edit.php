        ...
        <div class="col">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col">
                            <h1 class="h5 text-gray-800"><strong>MENU INFORMASI UBAH BHABINKAMTIBMAS & KRING SERSE</strong></h1>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form id="test" enctype="multipart/form-data" method="POST" onsubmit="return false">
                                <?php foreach ($bhabin as $record1) : ?>
                                    <div class="row mb-3">
                                        <div class="col-sm-2">
                                            <label><strong>Foto Bhabin: <i class="text-danger">*</i></strong></label>
                                            <?php $gambar1 = ($record1->TIPE_FOTO_BHABIN == 'url') ? $record1->FOTO_BHABIN : base_url('assets/upload/bhabin/') . $record1->FOTO_BHABIN; ?>
                                            <img id="image-preview_1" src="<?= $gambar1; ?>" width="140" height="120" onclick="show_modal(1)">
                                            <input type="hidden" name="ID" id="ID" value="<?= $record1->ID_BHABIN; ?>">
                                            <input type="hidden" name="FOTO_BHABIN" id="FOTO_BHABIN" value="<?= $record1->FOTO_BHABIN; ?>">
                                            <input type="hidden" name="TIPE_FOTO_BHABIN" id="TIPE_FOTO_BHABIN" value="<?= $record1->TIPE_FOTO_BHABIN; ?>">
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="row mb-2">
                                                <div class="col">
                                                    <label><strong>Nama Bhabin: <i class="text-danger">*</i></strong></label>
                                                    <input type="text" class="form-control" name="NAMA_BHABIN" value="<?= $record1->NAMA_BHABIN; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <label><strong>Telpon Bhabin: <i class="text-danger">*</i></strong></label>
                                                    <input type="number" class="form-control" name="TLP_BHABIN" value="<?= $record1->TLP_BHABIN; ?>">
                                                </div>
                                                <div class="col">
                                                    <label><strong>WhatsApp Bhabin: <i class="text-danger">*</i></strong></label>
                                                    <input type="number" class="form-control" name="WA_BHABIN" value="<?= $record1->WA_BHABIN; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-2">
                                            ...
                                            <?php $gambar2 = ($record1->TIPE_FOTO_KRINGSERSE == 'url') ? $record1->FOTO_KRINGSERSE : base_url('assets/upload/bhabin/') . $record1->FOTO_KRINGSERSE; ?>
                                            <img id="image-preview_2" src="<?= $gambar2; ?>" width="140" height="120" onclick="show_modal(2)">
                                            <input type="hidden" name="FOTO_KRINGSERSE" id="FOTO_KRINGSERSE" value="<?= $record1->FOTO_KRINGSERSE; ?>">
                                            <input type="hidden" name="TIPE_FOTO_KRINGSERSE" id="TIPE_FOTO_KRINGSERSE" value="<?= $record1->TIPE_FOTO_KRINGSERSE; ?>">
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="row mb-2">
                                                <div class="col">
                                                    <label><strong>Nama Kring Serse: <i class="text-danger">*</i></strong></label>
                                                    <input type="text" class="form-control" name="NAMA_KRINGSERSE" value="<?= $record1->NAMA_KRINGSERSE; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <label><strong>Telpon Kring Serse: <i class="text-danger">*</i></strong></label>
                                                    <input type="number" class="form-control" name="TLP_KRINGSERSE" value="<?= $record1->TLP_KRINGSERSE; ?>">
                                                </div>
                                                <div class="col">
                                                    <label><strong>WhatsApp Kring Serse: <i class="text-danger">*</i></strong></label>
                                                    <input type="number" class="form-control" name="WA_KRINGSERSE" value="<?= $record1->WA_KRINGSERSE; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <select name="ID_KELURAHAN" class="form-control">
                                                        ...
                                                        <?php foreach ($wilayah as $record2) : ?>
                                                            <option <?= ($record2->ID_KELURAHAN == $record1->ID_KELURAHAN) ? 'selected' : ''; ?> value="<?= $record2->ID_KELURAHAN; ?>"><?= $record2->KELURAHAN . ' - ' . $record2->KECAMATAN; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <select name="PUBLISH" class="form-control">
                                                        <option value="">== PILIH ==</option>
                                                        <option value="1" <?= $record1->PUBLISH == 1 ? 'selected' : ''; ?>>DIPUBLIKASIKAN</option>
                                                        <option value="0" <?= $record1->PUBLISH == 0 ? 'selected' : ''; ?>>DIARSIPKAN</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function form_submit() {
        ...
        $.ajax({
            url: "<?= base_url('admin/bhabin_update/'); ?>",
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
