...
!(function (t, e) {
	...
	function ye(t, e, i, n) {
				...
				if (void 0 === e || void 0 === i) {
					...
					if (s) {
						...
						(e = t.width - l.width - r.width),
							...
							(n = fe(a.maxWidth, s, "clientWidth")),
							(o = fe(a.maxHeight, s, "clientHeight"));
		...
		return (
			...
			(c = _e(Math.min(c, a, l.maxWidth))),
			(h = _e(Math.min(h, r, l.maxHeight))),
			c && !h && (h = _e(c / 2)),
			{ width: c, height: h }
		);
	}
	...
	function Xe(t, e, i) {
		...
		U(i.pos) ||
			...
			(t[i.pos] += i.size)),
			n.getPadding && Ue(o, n.getPadding());
	...
	function Ke(t, e, i) {
		...
		for (o = 0, s = t.length, l = 0; o < s; ++o) {
			(a = t[o]),
				(r = a.box),
				r.update(a.width || e.w, a.height || e.h, qe(a.horizontal, e));
	...
	class ui extends Qe {
		...
		removeEventListener(t, e) {
			const i = t.$proxies || (t.$proxies = {}),
				n = i[e];
			if (!n) return;
			(({ attach: hi, detach: hi, resize: hi }[e] || ni)(t, e, n),
				(i[e] = void 0));
		}
		getDevicePixelRatio() {
	...
	const gi = (t) => 0 === t || 1 === t,
		...
		xi = {
			...
			easeInOutBounce: (t) =>
				t < 0.5
					? 0.5 * xi.easeInBounce(2 * t)
					: 0.5 * xi.easeOutBounce(2 * t - 1) + 0.5,
		},
		bi = "transparent",
		_i = {
	...
	class yi {
		constructor(t, e, i, n) {
			...
			(this._active = !0),
				(this._fn = t.fn || _i[t.type || typeof s]),
	...
	function Oi(t, e) {
		...
		for (let t = 0; t < d; ++t) {
			const i = e[t],
				{ [l]: n, [c]: s } = i;
			(u = (i._stacks || (i._stacks = {}))[c] = Di(o, h, n)),
				(u[r] = s),
				(u._top = Ci(u, a, !0)),
				(u._bottom = Ci(u, a, !1));
		}
	...
	class Ei {
		...
		applyStack(t, e, i) {
			const n = this.chart,
				o = this._cachedMeta,
				s = e[t.axis];
			return Si({ keys: ki(n, !0), values: e._stacks[t.axis] }, s, o.index, {
				mode: i,
			});
		}
		updateRangeFromParsed(t, e, i, n) {
			...
			n &&
				...
				(s = Si(n, o, this._cachedMeta.index, { all: !0 }))),
				(t.min = Math.min(t.min, s)),
				(t.max = Math.max(t.max, s));
		}
		getMinMax(t, e) {
	...
	(Ei.defaults = {}),
		(Ei.prototype.datasetElementType = null),
		(Ei.prototype.dataElementType = null);
	class zi {
		constructor() {
			(this.x = void 0),
				(this.y = void 0),
	...
	function Wi(t, e) {
		...
		if (s > 0) {
			...
			for (Ni(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++)
				Ni(e, l, c, o[t], o[t + 1]);
	...
	class qi extends zi {
		...
		update(t, e, i) {
			...
			n.beforeUpdate(),
				...
				n._dataLimitsCached ||
					...
					n.afterDataLimits(),
					(n._range = We(n, n.options.grace)),
					(n._dataLimitsCached = !0)),
				n.beforeBuildTicks(),
				(n.ticks = n.buildTicks() || []),
				n.afterBuildTicks();
			const a = s < n.ticks.length;
			n._convertTicksToLabels(a ? ji(n.ticks, s) : n.ticks),
				n.configure(),
				...
				o.display &&
					...
					((n.ticks = Wi(n, n.ticks)), (n._labelSizes = null)),
			...
			(a = e.offset ? t.maxWidth / n : f / (n - 1)),
				d + 6 > a &&
					...
					(r =
						...
						Yi(e.grid) -
						i.padding -
						Ui(e.title, t.chart.options.font)),
					(l = Math.sqrt(d * d + u * u)),
					(c = zt(
						Math.min(
		...
		fit() {
			...
			if (a) {
				...
				if (
					(r
						? ((e.width = t.maxWidth), (e.height = Yi(s) + a))
						: ((e.height = t.maxHeight), (e.width = Yi(s) + a)),
			...
			get: (i, n) =>
				tn(i, n, () =>
					(function (t, e, i, n) {
						let o;
						for (const s of e)
							if (((o = rn(Qi(s, t), i)), ht(o)))
								return Ji(t, o) ? sn(i, n, t, o) : o;
					})(n, e, t, i)
				),
	...
	function Zi(t, e = { scriptable: !0, indexable: !0 }) {
		const {
	...
	function pn(t, e, i, n, o) {
		...
		if (
			...
			for (s = 0, a = t.length; s < a; ++s)
				(r = t[s]),
					(l = un(i, r, t[Math.min(s + 1, a - (n ? 0 : 1)) % a], e.tension)),
					(r.cp1x = l.previous.x),
					(r.cp1y = l.previous.y),
					(r.cp2x = l.next.x),
					(r.cp2y = l.next.y),
				...
				for (i = 0, n = t.length; i < n; ++i)
					(a = s),
						...
						s &&
							((o = t[i]),
							a &&
								((o.cp1x = gn(o.cp1x, e.left, e.right)),
								(o.cp1y = gn(o.cp1y, e.top, e.bottom))),
							r &&
								((o.cp2x = gn(o.cp2x, e.left, e.right)),
								(o.cp2y = gn(o.cp2y, e.top, e.bottom))));
			})(t, i);
	}
	function mn(t, e, i, n) {
	...
	function Mn({ start: t, end: e, count: i, loop: n, style: o }) {
		return {
			start: t % i,
			end: e % i,
			loop: n && (e - t + 1) % i == 0,
	...
	function kn(t, e, i) {
		...
		const { property: n, start: o, end: s } = i,
			a = e.length,
			{ compare: r, between: l, normalize: c } = wn(n),
			{
				start: h,
				end: d,
				loop: u,
			...
			(m = e[t % a]),
				m.skip ||
					...
					p !== x &&
						...
						null !== _ &&
							v() &&
							(g.push(Mn({ start: _, end: t, loop: u, count: a, style: f })),
							(_ = null)),
						(i = t),
						(x = p)));
		return (
			null !== _ &&
				g.push(Mn({ start: _, end: d, loop: u, count: a, style: f })),
			g
		);
	}
	function Sn(t, e) {
		...
		return i && i.setContext && e
			? (function (t, e, i) {
					...
					for (const r of t) {
						...
						for (a = s + 1; a <= r.end; a++) {
							const h = e[a % n];
							(l = Cn(i.setContext({ type: "segment", p0: c, p1: h }))),
								On(l, t) &&
	...
	var Ln = new (class {
		constructor() {
			(this.controllers = new An(Ei, "datasets", !0)),
				(this.elements = new An(zi, "elements")),
				(this.plugins = new An(Object, "plugins")),
				(this.scales = new An(qi, "scales")),
				...
				? (function (t, e, i, n) {
						...
						for (let a = 0; a < e.length; a++) {
							const r = e[a],
								l = En(i[r.id], n);
							null !== l &&
								o.push({ plugin: r, options: zn(t.config, r, l, s) });
						}
						return o;
				  })(t, o, n, e)
				: [];
		...
		getOptionScopes(t, e, i) {
			...
			e.forEach((e) => {
				t && (r.add(t), e.forEach((e) => jn(r, t, e))),
					e.forEach((t) => jn(r, n, t)),
					e.forEach((t) => jn(r, ft[o] || {}, t)),
					e.forEach((t) => jn(r, xt, t)),
					e.forEach((t) => jn(r, gt, t));
			});
	...
	class eo {
		constructor(t, e) {
			...
			(this.id = j()),
				...
				(Jn[n.id] = n),
				l && c
					? (a.listen(n, "complete", Kn),
					  a.listen(n, "progress", Gn),
					  n._initialize(),
					  n.attached && n.update())
					: console.error(
		...
		_initialize() {
			...
			return (
				...
				t.options.responsive ? t.resize() : ve(t, t.options.devicePixelRatio),
				t.bindEvents(),
			...
			i &&
				...
				J(s, (i) => {
					const s = i.options,
						...
						r = Fn(a, s),
						l = K(s.type, i.dtype);
					(void 0 !== s.position && Xn(s.position, r) === Xn(i.dposition)) ||
	...
	Object.defineProperties(eo, {
		defaults: { enumerable: no, value: xt },
		instances: { enumerable: no, value: Jn },
		overrides: { enumerable: no, value: ft },
		registry: { enumerable: no, value: Ln },
		version: { enumerable: no, value: "3.4.1" },
	...
	function wo(t, e, i, n) {
		const o = Ee(t.options.borderRadius, [
			"outerStart",
			"outerEnd",
			"innerStart",
			"innerEnd",
	...
	function To(t, e, i, n) {
		const { points: o, options: s } = e,
			{ count: a, start: r, loop: l, ilen: c } = Oo(o, i, n),
			h = (function (t) {
				return t.stepped
					? Jt
	...
	class zo extends zi {
		...
		get segments() {
			return (
				this._segments || (this._segments = Pn(this, this.options.segment))
			);
		}
		first() {
	...
	function Vo(t) {
		...
		return e
			? ((e = t.horizontal
					? Wo(e, "left", "right", t.base > t.x)
					: Wo(e, "bottom", "top", t.base < t.y)),
			  (i[e] = !0),
			  i)
			: i;
	}
	...
	function ss(t, e) {
		...
		return (
			...
			i.length
				? new zo({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
				: null
		);
	}
	function as(t, e, i) {
					...
					for (const e of c) {
						...
						for (const t of r)
							a.push({
								source: t,
								target: e,
								start: { [i]: cs(l, n, "start", Math.max) },
								end: { [i]: cs(l, n, "end", Math.min) },
							});
					}
				}
				return a;
			...
			(function (t, e) {
				...
				t.save(),
					"x" === l &&
						s !== o &&
						(rs(t, n, a.top),
						us(t, { line: i, target: n, color: o, scale: r, property: l }),
						t.restore(),
						t.save(),
						rs(t, n, a.bottom)),
					us(t, { line: i, target: n, color: s, scale: r, property: l }),
					t.restore();
			})(t, {
				line: o,
				target: n,
	...
	class ms extends zi {
		...
		adjustHitBoxes() {
			...
			if (this.isHorizontal()) {
				...
				for (const a of i)
					r !== a.row &&
						((r = a.row), (l = o(n, t.left + s, t.right - t.lineWidths[r]))),
						(a.top += t.top + e + s),
						(a.left = l),
						(l += a.width + s);
				if (a) {
					const e = i.reduce(
							(t, e) => ((t[e.row] = t[e.row] || []), t[e.row].push(e), t),
							{}
						),
						n = [];
		...
		_draw() {
			...
			t.drawTitle(),
				...
				(a.lineWidth = 0.5),
				(a.font = d.string);
			const { boxWidth: x, boxHeight: b, itemHeight: _ } = ps(l, g),
				y = t.isHorizontal(),
	...
	function Cs(t, e, i) {
		...
		return { xAlign: e.xAlign || Ds(t, e, i, n), yAlign: n };
	}
	function Os(t, e, i, n) {
			...
			return (
				J(t, (t) => {
					const e = { before: [], lines: [], after: [] },
						s = Ls(n, t);
					Ms(e.before, ks(s.beforeLabel.call(i, t))),
						Ms(e.lines, s.label.call(i, t)),
						Ms(e.after, ks(s.afterLabel.call(i, t))),
						o.push(e);
				}),
				o
			);
	...
	var Es = {
			...
			positioners: ws,
			afterInit(t, e, i) {
				i && (t.tooltip = new Rs({ _chart: t, options: i }));
			},
			beforeUpdate(t, e, i) {
	...
	(Fs.id = "category"),
		(Fs.defaults = { ticks: { callback: Fs.prototype.getLabelForValue } });
	class Vs extends qi {
		constructor(t) {
			super(t),
				(this.start = void 0),
			...
			const o = (function (t, e) {
				...
				for (
					...
					(d && v !== s
						? (i.push({ value: s }),
						  v < s && P++,
						  At(Math.round((v + P * k) * y) / y, s, Bs(s, _, t)) && P++)
						: v < s && P++);
					P < M;
					++P
				)
				...
				return (
					x && d && w !== a
						? At(i[i.length - 1].value, a, Bs(a, _, t))
	...
	(Ws.id = "linear"),
		(Ws.defaults = { ticks: { callback: Vi.formatters.numeric } });
	class Hs extends qi {
		constructor(t) {
			super(t),
				(this.start = void 0),
	...
	class Zs extends Vs {
		...
		generateTickLabels(t) {
			const e = this;
			Vs.prototype.generateTickLabels.call(e, t),
	...
	(Zs.id = "radialLinear"),
		...
		(Zs.descriptors = { angleLines: { _fallback: "grid" } });
	const Qs = {
	...
	class sa extends qi {
		...
		buildTicks() {
			...
			return (
				(t._unit =
					i.unit ||
					(n.autoSkip
						? ia(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
						: (function (t, e, i, n, o) {
								for (let s = Js.length - 1; s >= Js.indexOf(i); s--) {
									const i = Js[s];
									if (Qs[i].common && t._adapter.diff(o, n, i) >= e - 1)
										return i;
								}
		...
		_generate() {
			...
			return (
				(d !== n && "ticks" !== o.bounds && 1 !== u) || na(h, d, g),
				Object.keys(h)
					.sort((t, e) => t - e)
					.map((t) => +t)
			);
	...
	class ra extends sa {
		...
		initOffsets() {
			...
			(t._minPos = aa(i, t.min)),
				(t._tableRange = aa(i, t.max) - t._minPos),
				super.initOffsets(e);
		}
		buildLookupTable(t) {
	...
	return (
		eo.register(yo, la, Xo, zs),
		(eo.helpers = { ...Tn }),
		(eo._adapters = ao),
		(eo.Animation = yi),
		(eo.Animations = wi),
		(eo.animator = a),
		(eo.controllers = Ln.controllers.items),
		(eo.DatasetController = Ei),
		(eo.Element = zi),
		(eo.elements = Xo),
		(eo.Interaction = Te),
		(eo.layouts = Ze),
		...
		(eo.Scale = qi),
		(eo.Ticks = Vi),
		Object.assign(eo, yo, la, Xo, zs, fi),
		(eo.Chart = eo),
		"undefined" != typeof window && (window.Chart = eo),
		eo
	);
});
